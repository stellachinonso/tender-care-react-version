...
import HospitalConnect from "./pages/connect/HospitalConnect";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          exact
          path="/auth/generate-profile"
          element={<GenerateProfile />}
        />
        <Route
          exact
        ...
        <Route
          ...
          element={<DevelopmentTracker />}
        />
        <Route exact path="/about" element={<AboutUs />} />
        <Route exact path="/resources" element={<Resources />} />
        <Route exact path="/src/pages/connect" element={<HospitalConnect />} />
      </Routes>
    </BrowserRouter>
  );
}
